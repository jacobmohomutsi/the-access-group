...
export const OrderConfirmationEmail = ({
    ...
    return (
        <Html>
            <Head />
            <Preview>Your Summit Order Confirmation - {orderNumber}</Preview>
            <Body style={main}>
                <Container style={container}>
                    <Section style={header}>
                        <Heading style={heading}>The Access Group</Heading>
                        <Text style={subheading}>Payment Received</Text>
                    </Section>
                    
                    <Section style={content}>
                        <Text style={text}>Hi {buyerName},</Text>
                        <Text style={text}>
                            Thank you for your purchase. We have successfully received your payment for order <strong>{orderNumber}</strong>.
                        </Text>
                        ...
                        <Text style={text}>
                            You can now assign names to your tickets and download them using the button below.
                        </Text>
