...
export default function PartnershipModal({ isOpen, onClose, partnershipTier }) {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          subject: partnershipTier || 'Partnership Application',
          message: `Partnership tier: ${partnershipTier || 'Not specified'}`,
        }),
      });
      if (!response.ok) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-[2rem] bg-primary p-8 text-white shadow-2xl shadow-black/40">
        ...
        {status === 'success' ? (
          ...
          <>
            <p className="text-sm font-semibold uppercase tracking-[0.28em] text-white">Apply for Partnership</p>
            <h3 className="mt-3 text-3xl font-bold">Partner with us for IEAS 2026.</h3>
            <p className="mt-4 text-white/65">
              Submit your details to express interest in a partnership. Our team will get back to you with more information.
            </p>
